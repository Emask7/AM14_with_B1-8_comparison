...
DEG_lists <- list(
  PL23_2DG_vs_Ctrl = deg_list_for_venn(deseq_res$AM14transfer_PL23, 1),
  R848_2DG_vs_Ctrl = deg_list_for_venn(deseq_res$AM14transfer_R848, 1),
  B18 = deg_list_for_venn(deseq_res$B18transfer, 1),
  MRLlpr = deg_list_for_venn(deseq_res$AM14MRLlpr, 1)
)

DEG_lists_lfc0.6 <- list(
  PL23_2DG_vs_Ctrl = deg_list_for_venn(deseq_res$AM14transfer_PL23, 0.6),
  R848_2DG_vs_Ctrl = deg_list_for_venn(deseq_res$AM14transfer_R848, 0.6),
  B18 = deg_list_for_venn(deseq_res$B18transfer, 0.6),
  MRLlpr = deg_list_for_venn(deseq_res$AM14MRLlpr, 0.6)
)
