setwd("Z:/Emma Mask/R_projects/AM14_with_B1-8_comparison/public_GSE_datasets/")
# # setwd("./public_GSE_datasets/")
getwd()
...
# 
# write.table(abc_up_genes, file = "GSE_lists/GSE99480_ABC_up_regulated_genes.txt",
#             quote = FALSE, row.names = FALSE, col.names = FALSE)
# 
# write.table(abc_down_genes, file = "GSE_lists/GSE99480_ABC_down_regulated_genes.txt",
#             quote = FALSE, row.names = FALSE, col.names = FALSE)
# 
